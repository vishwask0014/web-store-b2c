...
import type { WalletTotals } from "@/types/dashboard";
...
const CARDS = [
  { key: "revenue" as const, label: "Total Revenue", icon: Wallet, color: "#3B82F6" },
  { key: "commission" as const, label: "Commission", icon: Percent, color: "#8B5CF6" },
  { key: "pendingPayout" as const, label: "Pending Payout", icon: Hourglass, color: "#F59E0B" },
  { key: "withdrawals" as const, label: "Withdrawals", icon: ArrowDownToLine, color: "#22C55E" },
];
