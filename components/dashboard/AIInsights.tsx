...
import type { AiInsights as AiInsightsData } from "@/types/dashboard";
...
const ROWS = [
  { key: "todayRevenue" as const, label: "Today's Revenue", icon: TrendingUp, format: "currency" },
  { key: "topStore" as const, label: "Top Performing Store", icon: StoreIcon },
  { key: "bestProduct" as const, label: "Best Selling Product", icon: Package },
  { key: "pendingOrders" as const, label: "Pending Orders", icon: Clock },
  { key: "pendingRefunds" as const, label: "Pending Refunds", icon: RotateCcw },
  { key: "lowStock" as const, label: "Low Stock Products", icon: AlertTriangle },
];
