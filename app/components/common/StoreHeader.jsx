    ...
    <header className="sticky top-0 z-50 border-b border-border-default bg-bg-primary/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <nav className="hidden items-center gap-1 ml-2 rounded-full border border-border-divider bg-bg-surface/80 p-1 md:flex">
            <Link
              href="/shop"
        ...
        <div className="flex items-center gap-2 md:gap-3 shrink-0">
          ...
          <div className="pl-3 md:pl-4 border-l border-border-divider hidden sm:block">
            {user ? (
              ...
              <Link
                href="/auth"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-primary-500 text-white text-sm font-medium shadow-md shadow-primary-500/25 hover:bg-primary-600 transition-colors"
              >
                Sign in
              </Link>
            )}
